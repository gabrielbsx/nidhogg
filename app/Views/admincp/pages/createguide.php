    ...
    <div id="news_filter">
        ...
        <div style="border: 1px solid #222222;">
            ...
            <ul id="news_list_all" style="padding:10px;">
                <form id="login_form" class="login-form block-p" method="POST" action="<?= base_url('auth/createguide') ?>">
                    <div class="input-user">
                        <input type="text" class="form-control my-3" name="name" placeholder="Nome do guia">
                    </div>
