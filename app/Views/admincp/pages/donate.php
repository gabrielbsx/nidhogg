        ...
        <div style="border: 1px solid #222222;padding:10px;">
            ...
            <ul id="news_list_all">
                <div style="margin:10px 0;text-align:center;">
                    <a href="<?= base_url('admin/packagedonate') ?>" style="background-color:rgb(55,55,55);padding:10px 20px;display:block;width:100%;text-align:center;margin:0 auto;">Adicionar novo pacote</a>
                </div>
