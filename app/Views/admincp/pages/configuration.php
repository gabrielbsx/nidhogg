        ...
        <div style="border: 1px solid #222222;">
            ...
            <ul id="news_list_all">
                <?php if (isset($configuration)) : ?>
                    <form id="login_form" class="container form mx-auto form-filter-user" method="POST" action="<?= base_url('auth/config') ?>">
                        <?php foreach ($configuration as $key => $value) : ?>
                            ...
                            <div class="input-user">
                                ...
                                <input class="form-control my-3" type="text" name="<?= $key ?>" value="<?= $value ?>">
                            </div>
                        <?php endforeach; ?>
