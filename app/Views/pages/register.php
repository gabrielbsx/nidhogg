...
<section class="mb_large" id="news">
    <div id="news_filter">
        ...
        <div style="border: 1px solid #222222;">
            ...
            <ul id="news_list_all" >
                <form class="container form mx-auto form-filter-user" method="POST" action="<?= base_url('auth/register') ?>">
                    <input class="form-control my-3" name="username" type="text" placeholder="Login">
