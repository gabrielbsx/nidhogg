...
<section class="mb_large" id="news">
    <div id="news_filter">
        ...
        <div style="border: 1px solid #222222;">
            ...
            <ul id="news_list_all container" style="padding:10px;margin:10px;">
                <?php if (isset($news)) : ?>
                    <div class="last-more-top" style="padding:10px;border-bottom:1px solid rgba(155,155,155,0.2);">
                        <?= $news['title'] ?>
                    </div>
