...
<section class="mb_large" id="news">
    <div id="news_filter">
        ...
        <div style="border: 1px solid #222222;">
            ...
            <ul id="news_list_all">
                <form class="container form mx-auto form-filter-user" method="POST" action="<?= base_url('auth/alterpass') ?>">
                    <input class="form-control my-3" name="oldpassword" type="password" placeholder="Senha Antiga">
                    <input class="form-control my-3" name="password" type="password" placeholder="Senha">
                    <input class="form-control my-3" name="password_confirm" type="password" placeholder="Confirmar Senha">
